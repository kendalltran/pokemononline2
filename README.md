...
## Step 16:  Launch the Web application
  ...
  5. Use cd /var/www to move to the /var/www directory
  6. Create the application directory, sudo mkdir FlaskApp
  7. Move inside this directory using cd FlaskApp
  5. Clone the Catalog App to the virtual machine
    1. git clone https://github.com/kendalltran/pokemon
    2. Rename the project's name sudo mv ./pokemon ./FlaskApp
    3. Move to the inner FlaskApp directory using cd FlaskApp
    4. Rename website.py to __init__.py using sudo mv website.py __init__.py
    5. Edit database_setup.py, website.py and functions_helper.py and change
      engine = create_engine('sqlite:///toyshop.db') to
      engine = create_engine('postgresql://catalog:password@localhost/catalog')
    6. Install pip sudo apt-get install python-pip
    7. Use pip to install dependencies sudo pip install -r requirements.txt
    8. Install psycopg2 sudo apt-get -qqy install postgresql python-psycopg2
  ...
  734  exit
  735  cd /var/log/apache2/
  736  sudo su
  737  sudo apt-get remove libapache2-mod-python libapache2-mod-wsgi
  738  sudo apt-get install libapache2-mod-wsgi-py3
  739  cd /var//www/
  740  ls
  741  cd FlaskApp/
  742  ls
  743  ll
  744  sudo chmod u+x flaskapp.wsgi
  745  ll
  746  chmod u+x flaskapp.wsgi
  747  ls
  748  cd FlaskApp/
  749  ls
  750  pip3 install requirements.txt
  751  pip3 install -R requirements.txt
  752  pip3 install -r requirements.txt
  753  sudo apt-get install python-setuptools libapache2-mod-wsgi
  754  sudo service apache2 restart
  755  sudo a2enmod wsgi
  756  sudo service apache2 restart
